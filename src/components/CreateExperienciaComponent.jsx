...
class CreateExperienciaComponent extends Component {
    constructor(props) {
        ...
        this.saveOrUpdateExperiencia = this.saveOrUpdateExperiencia.bind(this);
    }
    ...
    getTitle(){
        if(this.state.id === '_add'){
            return <h3 className="text-center">Adicionar Experiencia</h3>
        }else{
            return <h3 className="text-center">Atualizar Experiencia</h3>
        }
    }
    render() {
        return (
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <button className="btn btn-success" onClick={this.saveOrUpdateExperiencia}>Salvar</button>
...
export default CreateExperienciaComponent;