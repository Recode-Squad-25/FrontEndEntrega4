...
class CreateEmpresaComponent extends Component {
    constructor(props) {
        super(props)
    ...
    getTitle(){
        if(this.state.id === '_add'){
            return <h3 className="text-center">Adicionar Empresa</h3>
        }else{
            return <h3 className="text-center">Atualizar Empresa</h3>
        }
    }
    render() {
        return (
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <button className="btn btn-success" onClick={this.saveOrUpdateEmpresa}>Salvar</button>
...
export default CreateEmpresaComponent;