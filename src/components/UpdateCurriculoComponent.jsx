...
class UpdateCurriculoComponent extends Component {
    constructor(props) {
        ...
        this.updateCurriculo = this.updateCurriculo.bind(this);
    }
                   ...
                   <div className = "container">
                        <div className = "row">
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                <h3 className="text-center">Atualizar Curriculo</h3>
                                <div className = "card-body">
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <button className="btn btn-success" onClick={this.updateCurriculo}>Salvar</button>
...
export default UpdateCurriculoComponent;